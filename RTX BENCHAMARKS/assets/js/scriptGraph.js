...
function createChart(canvasId, resolutionData, title, yAxisLabel) { // Added yAxisLabel parameter
        ...
        options: {
            ...
            scales: {
                ...
                y: {
                    ...
                    title: { 
                        display: true, 
                        text: yAxisLabel, // Use the passed yAxisLabel parameter
                        color: "white", 
                        font: { size: 16 } 
                    }
                }
...
// Create the charts with unique y-axis labels
createChart("chart1080p", data1080p, "1080p (Full HD) - Ultra Settings", "CyberPunk 2077 - Ultra settings 1080p"); // Placeholder label
createChart("chart1440p", data1440p, "1440p (QHD) - Ultra Settings", "CyberPunk 2077 - Ultra settings 1440p");     // Placeholder label
createChart("chart2160p", data2160p, "2160p (4K) - Ultra Settings", "CyberPunk 2077 - Ultra settings 2160p");       // Placeholder label